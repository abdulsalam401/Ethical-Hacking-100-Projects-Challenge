...
- **Developer:** **Abdul Salam** (salam.cyber1)
- **Portfolio Website:** [salamcs.app](https://salamcs.app)
- **GitHub Profile:** [@abdulsalam401](https://github.com/abdulsalam401)
- **LinkedIn:** [Abdul Salam](https://www.linkedin.com/in/abdul-salam-39467a274)

---

## ⚠️ Ethical & Legal Disclaimer
> **IMPORTANT NOTICE:** The code, tools, and materials in this repository are created solely for **educational purposes, defensive research, and authorized security auditing**. 
> 
> Running scans, interception tools, or exploitation scripts against systems without **explicit, written authorization** is illegal and punishable by law. The author (**Abdul Salam**) assumes no responsibility or liability for how these scripts are used, any system damage caused, or legal actions resulting from misuse of this code. Always practice safe, legal, and ethical hacking.

---

## 📂 Project Index

This table catalogs all completed security research projects, linking to their respective directories which contain source code and detailed execution instructions.
...
| 11 | **Ransomware Encryption Simulator Lab** | An educational demonstration of cryptographic file locking and unlocking. | `Python 3`, `cryptography (cryptography.fernet)` | [View Project](./Project_11_Ransomeware_Simulator) |
...
| 14 | **802.11 Wi-Fi Deauthentication Attack Detector** | A wireless security monitoring tool that sniffs 802.11 frames to detect Wi-Fi Deauthentication attacks (which force clients offline). | `Python 3`, `Scapy`, `Monitor Mode Interface tools` | [View Project](./Project_13_Deauth_Detector) |
...
| 21 | **LSB Steganography Tool with PBKDF2 Password Encryption** | A steganography tool that embeds and extracts secret data inside PNG images. | `Python 3`, `Pillow (PIL)`, `cryptography (or hashlib/hmac)` | [View Project](./Project_18_Steganography_Tool) |
...
| 26 | **Android APK Static Security Scanner** | A static analysis tool for Android applications (APKs). | `Python 3`, `zipfile`, `xml.etree.ElementTree` | [View Project](./Project_23_Android_App_Security_Scanner) |
| 27 | **Reverse Proxy Web Application Firewall (WAF)** | An inline reverse proxy Web Application Firewall. | `Python 3`, `http.server`, `urllib.parse` | [View Project](./Project_24_Web_Application_Firewall) |
...
```bash
pip install scapy cryptography requests paramiko dnslib web3 psutil colorama pyperclip beautifulsoup4 flask pycryptodome pillow
```
...
---
*Developed with 💻 and 🛡️ by [Abdul Salam](https://salamcs.app).*
